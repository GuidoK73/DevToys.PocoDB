...
namespace DevToys.PocoDB.Attributes
{
    ...
    public sealed class DBFieldAttribute : Attribute
    {
        ...
        internal static Dictionary<string, object> GetDBFieldPropertiesDefaults(Type type)
        {
            ...
            {
                DBFieldAttribute _attribute = property.GetCustomAttributes(typeof(DBFieldAttribute), true).FirstOrDefault() as DBFieldAttribute;

                object _defaultval = null;
                switch (_attribute.ReaderCustomDefault)
                {
                    ...
                    case ReaderDefaults.UseDefaultValueProperty:
                        _defaultval = _attribute.ReaderDefaultValue;
                        break;
                ...
                _result.Add(_attribute.Field, _defaultval);
            }
            return _result;
        }
    }
